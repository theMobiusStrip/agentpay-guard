...
| `bait-and-switch` | quote-vs-billed (Tier A; self-authored fixture) | $0.999000 | $0.999000 | $0.000000 (1 blocked) |
...
- p99 ≈ 4.651 ms per attempt. This is **create-path wall time** (dominated by EIP-712 signing), an **upper bound** on the guard's own reserve round-trip — the in-memory store ops are sub-ms. Measured on the identical code path for both arms.
